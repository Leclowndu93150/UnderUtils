...
public class BatteryStorage implements IBatteryStorage, INBTSerializable<Tag> {
    ...
    public @UnknownNullability Tag serializeNBT(HolderLookup.Provider provider) {
        ...
        UnderUtils.LOGGER.error("Error encoding BacteriaStorage: {}", tagDataResult.error().get().message());
        return null;
    }
    ...
    public void deserializeNBT(HolderLookup.Provider provider, Tag nbt) {
        ...
        if (dataResult.isSuccess()) {
            ...
            UnderUtils.LOGGER.error("Error decoding BacteriaStorage: {}", dataResult.error().get().message());
        }
    }
